...
class ScrapeBooking
  ...
  def self.call
    ...
    output_filename = "hotel_info_#{Date.today.strftime}.json"
...
ScrapeBooking("Paris", "4", "14", "2019", "4", "19", "2019").call
